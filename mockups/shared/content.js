/* ============================================================
   content.js — Ethan's copy as data + a renderer for the
   below-the-fold sections. Shared by all three mockups so the
...
window.CONTENT = {
  ...
  actions: [
    { label: 'Résumé',   href: '#',        kind: 'primary' },
...
/* ------------------------------------------------------------
   renderPage(mountEl) — builds every section below the hero.
   ------------------------------------------------------------ */
(function () {
  'use strict';
